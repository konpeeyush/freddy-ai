 ...
 * daily reference rates. No key, no quota, CORS open — callable directly
 * from a customer's page.
 *
 * Returns a *series* as well as a number, which is the only stock tool that
 * does — it backs the one stock widget with a chart.
 */
...
export const convertCurrency: ToolDefinition = {

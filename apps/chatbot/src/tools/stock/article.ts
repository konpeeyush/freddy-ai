 ...
 * Wikipedia lookups.
 *
 * Real article summaries, no key, CORS open. The one stock tool with a
 * remote image whose URL is not known until the call returns, and a link
...
export const lookupArticle: ToolDefinition = {
  name: "lookupArticle",
  description:
